...
<head>
  ...
  <title>“KidShopping”| Escritorio</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>“KidShopping” </b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>KID</b>SHOPPING</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Dante - Fiorela - Ruder <br> Desarrollo de software I
                  <small>Mayo 2023</small>
                </p>
              </li>
              <!-- Menu Footer-->
